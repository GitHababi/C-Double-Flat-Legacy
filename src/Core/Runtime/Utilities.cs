...
namespace C_Double_Flat.Core.Runtime
{
    ...
    {
        internal static Value GetValue(ExpressionNode final, ref Dictionary<string, Value> vars)
        {
        ...
        internal static ExpressionNode GetExpNodeValue(ExpressionNode var, ref Dictionary<string, Value> vars)
        {
